...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Which crystal is right for me?", a: "Try our free Kundali Calculator to analyse your birth chart and recommend crystals based on your Rashi, Lagna, and planetary positions using Vedic astrology. It's the most personalised crystal recommendation you'll find." },
  ...
  },
  {
    ...
    items: [
      { q: "Is the Kundali reading really free?", a: "Yes, completely free. Enter your birth details and get a full Vedic birth chart with planetary positions, Rashi, Nakshatra, and personalised crystal recommendations instantly, with no email or payment required." },
      { q: "How accurate is the Vedic crystal recommendation?", a: "Our recommendations are based on classical Vedic astrology texts including Brihat Parashara Hora Shastra and Jataka Parijata. They identify which Navagraha (planet) needs strengthening and recommend the corresponding Navratna or healing crystal." },
